...
local sumneko_lua_root_path='/gpfs/home/ahurtado/.vscode-server/extensions/sumneko.lua-1.21.1'
local sumneko_binary='/gpfs/home/ahurtado/.vscode-server/extensions/sumneko.lua-1.21.1/server/bin/Linux/lua-language-server'
