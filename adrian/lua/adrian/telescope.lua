...
M.search_dotfiles = function()
    require("telescope.builtin").find_files({
        prompt_title = "< VimRC >",
        cwd = "$HOME/dotfiles/awesome-streamerrc/adrian/",
    })
end

M.search_madness = function()
    require("telescope.builtin").find_files({
        prompt_title = "< Mol Response >",
        cwd = "/gpfs/projects/rjh/adrian/madness/",
    })
end

M.search_testing = function()
    require("telescope.builtin").find_files({
        prompt_title = "< Mol Response >",
        cwd = "/gpfs/projects/rjh/adrian/responseTestingNovember2020/test_suite",
    })
end
