...
"hi Visual cterm=reverse gui=reverse ctermfg=DarkRed guifg=Red
ctermbg=Darkfg guibg=fg
hi Visual cterm=reverse gui=reverse ctermfg=LightGrey guifg=White
guibg=Black
hi VisualNOS cterm=underline gui=underline
hi Cursor cterm=reverse gui=reverse ctermbg=NONE guibg=NONE ctermfg=NONE
guifg=NONE
...
"hi FoldColumn ctermbg=DarkGrey guibg=DarkGrey ctermfg=DarkBlue
guifg=DarkBlue
hi FoldColumn guibg=#181818 ctermfg=DarkGrey guifg=DarkGrey
hi DiffText cterm=NONE gui=NONE ctermfg=DarkBlue guifg=DarkBlue
ctermbg=LightBlue guibg=LightBlue
hi DiffChange ctermfg=Black guifg=#202020 ctermbg=LightBlue guibg=#A0A0C0
hi DiffAdd ctermfg=DarkGreen guifg=DarkGreen ctermbg=LightGreen
guibg=LightGreen
...
"hi Statement cterm=NONE gui=NONE ctermfg=DarkYellow guifg=#CCCC00
guibg=Black
...
hi Todo term=standout ctermfg=DarkBlue guifg=Blue ctermbg=Yellow
guibg=Yellow

" Spelling
hi SpellBad term=reverse ctermfg=Black ctermbg=DarkRed gui=undercurl
guisp=Red
hi SpellCap term=reverse ctermfg=Black ctermbg=DarkBlue gui=undercurl
guisp=Blue
hi SpellRare term=reverse ctermfg=Black ctermbg=DarkMagenta gui=undercurl
guisp=Magenta
hi SpellLocal term=reverse ctermfg=Black ctermbg=DarkCyan gui=undercurl
guisp=Cyan
