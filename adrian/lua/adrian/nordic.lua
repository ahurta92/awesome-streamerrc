...
-- my highlight
Group.new('TabLineSel',          colors.fg,           colors.blue, styles.NONE )
...
Group.new('Error',          colors.nord_11,      colors.none,    styles.NONE)
Group.new('ErrorMsg',       colors.nord_5,       colors.nord_11, styles.NONE)
Group.new('WarningMsg',     colors.nord_5,       colors.nord_12, styles.NONE)
...
Group.new("Keyword",        colors.nord_7,       colors.none,    styles.NONE)
...
Group.new("Line",           colors.nord_12,      colors.none,    styles.NONE)
...
Group.new("Folded", colors.nord_14, colors.none, styles.NONE)
...
Group.new("LSPReferenceRead", colors.none, colors.none, styles.NONE)
Group.new("LSPReferenceWrite", colors.nord_9, colors.none, styles.NONE)

-- TeleScope
Group.new("TelescopeSelection", colors.nord_11, colors.nord_8, styles.NONE)
